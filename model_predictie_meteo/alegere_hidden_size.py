...
def train_and_evaluate(hidden_size):
    ...
    for epoch in range(num_epochs):
        ...
        print(f'Epoch [{epoch + 1}/{num_epochs}] Complete - Loss: {avg_loss:.4f} at {elapsed_time:.2f} seconds')
    ...
    print(f'Hidden Size: {hidden_size}, MAE: {mae:.4f}, MSE: {mse:.4f}, RMSE: {rmse:.4f}')
